...
SscVisualizer::SscVisualizer(rclcpp::Node::SharedPtr nh, int node_id)
  ...
  ssc_map_pub_ =
      nh_->create_publisher<visualization_msgs::msg::MarkerArray>(ssc_map_vis_topic, 1);
  ...
  forward_trajs_pub_ = nh_->create_publisher<visualization_msgs::msg::MarkerArray>(
      forward_trajs_vis_topic, 1);
  sur_vehicle_trajs_pub_ = nh_->create_publisher<visualization_msgs::msg::MarkerArray>(
      sur_vehicle_trajs_vis_topic, 1);
  corridor_pub_ =
      nh_->create_publisher<visualization_msgs::msg::MarkerArray>(corridor_vis_topic, 1);
}
...
void SscVisualizer::VisualizeCorridorsInSscSpace(
  ...
  common::VisualizationUtil::FillHeaderIdInMarkerArray(
      rclcpp::Clock().now(), std::string("ssc_map"), last_corridor_mk_cnt,
      &corridor_vec_marker);
