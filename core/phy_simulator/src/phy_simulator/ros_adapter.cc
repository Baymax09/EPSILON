...
RosAdapter::RosAdapter(rclcpp::Node::SharedPtr nh) : nh_(nh) {
  // arena_info_pub_ =
  // nh_->create_publisher<vehicle_msgs::msg::ArenaInfo>("arena_info", 10);
  arena_info_static_pub_ =
      nh_->create_publisher<vehicle_msgs::msg::ArenaInfoStatic>(
          "arena_info_static", 10);
  arena_info_dynamic_pub_ =
      nh_->create_publisher<vehicle_msgs::msg::ArenaInfoDynamic>(
          "arena_info_dynamic", 10);
}
